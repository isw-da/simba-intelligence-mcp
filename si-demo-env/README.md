> **Mirror.** The canonical engine lives in `isw-da/simba-intelligence-skill/si-demo-env`.
> This copy is kept here so the SI MCP toolkit is self-contained. Refresh with
> `scaffold.sh --sync` from the skill, or re-copy. Do not diverge it.
